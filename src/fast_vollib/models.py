...
def _finalize(values: np.ndarray, return_as: str, name: str, backend_name: str, return_native: bool):
...
def vectorized_black(flag, F, K, t, r, sigma, *, return_as="dataframe", dtype=np.float64, backend: BackendLiteral = "auto", return_native: bool = False):
...
def vectorized_black_scholes(flag, S, K, t, r, sigma, *, return_as="dataframe", dtype=np.float64, backend: BackendLiteral = "auto", return_native: bool = False):
    flag = preprocess_flags(flag)
...
def vectorized_black_scholes_merton(flag, S, K, t, r, sigma, q, *, return_as="dataframe", dtype=np.float64, backend: BackendLiteral = "auto", return_native: bool = False):
    flag = preprocess_flags(flag)
